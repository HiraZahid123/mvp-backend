    ...
    return (
        <>
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)} maxWidth="2xl">
                <div className="p-8">
                    <h2 className="text-2xl font-black text-primary-black mb-4">Open a Dispute</h2>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div>
                            ...
                            <textarea
                                id="reason"
                                className="w-full bg-oflem-cream border-gray-border rounded-[24px] p-5 text-sm font-medium focus:border-gold-accent focus:ring-0 min-h-[150px]"
                        ...
                        <div className="flex gap-4">
                            <button
                                ...
                                className="flex-1 py-3 bg-gray-200 text-primary-black font-black rounded-full hover:bg-gray-300 transition-all"
                            >
                                Cancel
                            </button>
                            <button
