...
export default function SocialLoginButton({ provider, type = 'login' }) {
    ...
    const labels = {
        register: {
            google: t("S'inscrire avec Google"),
            facebook: t("S'inscrire avec Facebook"),
            apple: t("S'inscrire avec Apple"),
        },
        login: {
            google: t("Se connecter avec Google"),
            facebook: t("Se connecter avec Facebook"),
    ...
    return (
        ...
        >
            ...
            <span>{labels[type][provider]}</span>
        </a>
    );
}
