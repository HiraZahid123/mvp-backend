                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    <div className="text-sm font-medium text-gray-500 dark:text-gray-400">Performers</div>
                                    <div className="text-2xl font-bold text-gray-900 dark:text-white">{stats.performers}</div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr key={user.id}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                                                        user.role_type === 'admin' ? 'bg-red-100 text-red-800' :
                                                        user.role_type === 'performer' ? 'bg-purple-100 text-purple-800' :
                                                        user.role_type === 'both' ? 'bg-green-100 text-green-800' :
